...
export default class RFB extends EventTargetMixin {
    ...
    clipboardPasteFrom(text) {
        ...
        if (this._clipboardServerCapabilitiesFormats[extendedClipboardFormatText] &&
            ...
            // Best-effort UTF-8 for servers that don't advertise extended clipboard.
            // This avoids replacing non-Latin characters with '?' on client side.
    ...
    _handleServerCutText() {
        ...
        if (length >= 0) {
            ...
            const text = decodeUTF8(rawText, true);
            if (this._viewOnly) {
                return true;
            }
